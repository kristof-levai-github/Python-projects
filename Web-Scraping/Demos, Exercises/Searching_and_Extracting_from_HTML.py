...
#find_all - part 1
soup.find_all('h4', {'class':'pull-right price'})[6:] #6. után minden (olyan, mintha [0] lenne az első, csak van möggötte / előtte egy : )
